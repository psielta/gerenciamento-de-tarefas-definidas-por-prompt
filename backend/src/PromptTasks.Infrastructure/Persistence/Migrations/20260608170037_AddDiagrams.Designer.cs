...
namespace PromptTasks.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260608170037_AddDiagrams")]
    partial class AddDiagrams
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PromptTasks.Domain.Diagrams.Diagram", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkingDirectoryId", "IsArchived");
            ...
            modelBuilder.Entity("PromptTasks.Domain.FutureTasks.FutureTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("IssueGithubId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.ToTable("future_tasks", (string)null);
                });

            modelBuilder.Entity("PromptTasks.Domain.FutureTasks.FutureTaskLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("FutureTaskId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FutureTaskId", "Label")
                        .IsUnique();

                    b.ToTable("future_task_labels", (string)null);
                });

            modelBuilder.Entity("PromptTasks.Domain.Notebooks.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PromptTasks.Domain.Notebooks.Notebook", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PromptTasks.Domain.Prompts.LinkedDocument", b =>
                {
                    ...
                    b.Property<string>("PullRequestReference")
                        .HasMaxLength(120)
            ...
            modelBuilder.Entity("PromptTasks.Domain.Workflows.PromptWorkflow", b =>
                {
                    ...
                    b.Property<string>("ReviewVerdictSourcePhaseName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("PromptTasks.Domain.FutureTasks.FutureTaskLabel", b =>
                {
                    b.HasOne("PromptTasks.Domain.FutureTasks.FutureTask", "FutureTask")
                        .WithMany("Labels")
                        .HasForeignKey("FutureTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FutureTask");
                });

            modelBuilder.Entity("PromptTasks.Domain.Notebooks.Note", b =>
                {
                    b.HasOne("PromptTasks.Domain.Notebooks.Notebook", "Notebook")
                        .WithMany("Notes")
